...
namespace Core.Tests.API.Controllers.Security
{
    ...
    public class UserControllerTests
    {
        ...
        public UserControllerTests()
        {
            ...
            _controller = new UserController(_coreContext);
        }
        ...
        {
            // arrange
            var expectedEntities = _coreContext.Users.OrderBy(p => p.Id).ToList();
            // act
        ...
        {
            // arrange
            var expectedEntity = _coreContext.Users.FirstOrDefault();
            // act
        ...
        public void PostTest()
        {
            ...
            // act
            var actualIDs = _controller.Post(new List<User> { entityToAdd });
            // assert
            var actualEntity = _coreContext.Users.FirstOrDefault(p => p.Id == actualIDs.ToList()[0]);
            if (actualEntity == null) Assert.Fail("actualEntity was null");
            Assert.AreEqual(actualIDs.ToList()[0], actualEntity.Id);
            //cleanup
            _coreContext.Users.Remove(actualEntity);
        ...
        public void PutTest()
        {
            ...
            _coreContext.Users.Add(entityToUpdate);
            _coreContext.SaveChanges();
            var expectedEntity = _coreContext.Users.OrderByDescending(p => p.LastUpdatedUtc).FirstOrDefault();
            // act
            if (expectedEntity == null) Assert.Fail("expectedEntity was null");
        ...
        public void DeleteTest()
        {
            ...
            _coreContext.Users.Add(entityToDelete);
            _coreContext.SaveChanges();
            var actualEntity = _coreContext.Users.OrderByDescending(p => p.LastUpdatedUtc).FirstOrDefault();
